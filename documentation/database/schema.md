...
**Last Updated:** 2025-10-14T19-00Z
**Database:** railway (yamabiko.proxy.rlwy.net:15649)
**Schema:** core (16 active tables)
**User:** rag_read (read-only)
**Backup Source:** /var/backups/db-sot/

## Quick Reference
- **Full Schema SQL:** `schema_latest.sql` (in this directory)
- **Column CSV:** `columns.csv` (in this directory)
- **Update Frequency:** Hourly via cron

## Active Tables

16 tables in the `core` schema:
...
- `file_pipeline_status` - File processing pipeline tracking
- `file_status` - File processing status
- `metrics` - Application metrics
- `password_reset_tokens` - Password reset tokens
- `password_resets` - Password reset records
- `social_content_generated` - Generated social media content
- `social_feedback_insights` - Performance insights
- `social_post_performance` - Post performance metrics
- `social_processed` - Processed social content
- `social_scheduling` - Optimal posting times
