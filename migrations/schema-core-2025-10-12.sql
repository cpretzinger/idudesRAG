...
\restrict 2oHLPYphtzw24nC64uKl1pK5D7e8Mz5qaEg4JY3CDqUSfmACfz6WlMRZkTZ9GzG
...
--
-- Name: assign_chunk_index(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.assign_chunk_index() OWNER TO postgres;

--
-- Name: calculate_performance_tier(numeric); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.calculate_performance_tier(p_engagement_rate numeric) OWNER TO postgres;

--
-- Name: cleanup_orphaned_embeddings(boolean); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.cleanup_orphaned_embeddings(p_dry_run boolean) OWNER TO postgres;

--
-- Name: coerce_chunk_index(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.coerce_chunk_index() OWNER TO postgres;

--
-- Name: document_embeddings_ingest4_upsert_fn(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.document_embeddings_ingest4_upsert_fn() OWNER TO postgres;

--
-- Name: generate_feedback_insights(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.generate_feedback_insights() OWNER TO postgres;

--
-- Name: FUNCTION generate_feedback_insights(); Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: get_optimal_posting_time(character varying, character varying, integer); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.get_optimal_posting_time(p_platform character varying, p_day_of_week character varying, p_priority_rank integer) OWNER TO postgres;

--
-- Name: FUNCTION get_optimal_posting_time(p_platform character varying, p_day_of_week character varying, p_priority_rank integer); Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: insert_document_chunk(uuid, text, public.vector, jsonb); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.insert_document_chunk(p_document_id uuid, p_text text, p_embedding public.vector, p_metadata jsonb) OWNER TO postgres;

--
-- Name: populate_embedding_columns(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.populate_embedding_columns() OWNER TO postgres;

--
-- Name: reindex_vectors(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.reindex_vectors() OWNER TO postgres;

--
-- Name: replace_embeddings(text, jsonb); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.replace_embeddings(_file_id text, _rows jsonb) OWNER TO postgres;

--
-- Name: schedule_10_day_campaign(date); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.schedule_10_day_campaign(start_date date) OWNER TO postgres;

--
-- Name: FUNCTION schedule_10_day_campaign(start_date date); Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: search_documents(public.vector, double precision, integer, character varying, jsonb); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.search_documents(query_embedding public.vector, similarity_threshold double precision, result_limit integer, file_type_filter character varying, metadata_filter jsonb) OWNER TO postgres;

--
-- Name: set_chunk_index_from_metadata(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.set_chunk_index_from_metadata() OWNER TO postgres;

--
-- Name: sync_text_column(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.sync_text_column() OWNER TO postgres;

--
-- Name: update_post_performance(uuid, character varying, integer, integer, integer, integer, integer, integer, integer); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.update_post_performance(p_content_id uuid, p_platform character varying, p_likes integer, p_comments integer, p_shares integer, p_saves integer, p_reach integer, p_impressions integer, p_clicks integer) OWNER TO postgres;

--
-- Name: FUNCTION update_post_performance(p_content_id uuid, p_platform character varying, p_likes integer, p_comments integer, p_shares integer, p_saves integer, p_reach integer, p_impressions integer, p_clicks integer); Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: update_table_stats(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.update_table_stats() OWNER TO postgres;

--
-- Name: update_updated_at_column(); Type: FUNCTION; Schema: core; Owner: postgres
--
...
ALTER FUNCTION core.update_updated_at_column() OWNER TO postgres;
...
--
-- Name: auth_logs; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.auth_logs OWNER TO postgres;

--
-- Name: drive_sync_state; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.drive_sync_state OWNER TO postgres;

--
-- Name: TABLE drive_sync_state; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: COLUMN drive_sync_state.page_token; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: COLUMN drive_sync_state.total_changes_processed; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: embeddings; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.embeddings OWNER TO postgres;

--
-- Name: embeddings_id_seq; Type: SEQUENCE; Schema: core; Owner: postgres
--
...
ALTER SEQUENCE core.embeddings_id_seq OWNER TO postgres;

--
-- Name: embeddings_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: postgres
--
...
--
-- Name: enrichment_logs; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.enrichment_logs OWNER TO postgres;

--
-- Name: file_status; Type: TABLE; Schema: core; Owner: postgres
--
...
CREATE TABLE core.file_status (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT file_status_status_check CHECK ((status = ANY (ARRAY['processing'::text, 'completed'::text, 'failed'::text])))
);


ALTER TABLE core.file_status OWNER TO postgres;

--
-- Name: metrics; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.metrics OWNER TO postgres;

--
-- Name: password_resets; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.password_resets OWNER TO postgres;

--
-- Name: social_content_generated; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.social_content_generated OWNER TO postgres;

--
-- Name: TABLE social_content_generated; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: social_feedback_insights; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.social_feedback_insights OWNER TO postgres;

--
-- Name: TABLE social_feedback_insights; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: social_post_performance; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.social_post_performance OWNER TO postgres;

--
-- Name: TABLE social_post_performance; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: social_scheduling; Type: TABLE; Schema: core; Owner: postgres
--
...
ALTER TABLE core.social_scheduling OWNER TO postgres;

--
-- Name: TABLE social_scheduling; Type: COMMENT; Schema: core; Owner: postgres
--
...
--
-- Name: embeddings id; Type: DEFAULT; Schema: core; Owner: postgres
--
...
--
-- Name: auth_logs auth_logs_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: drive_sync_state drive_sync_state_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: embeddings embeddings_file_id_chunk_index_key; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: embeddings embeddings_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: enrichment_logs enrichment_logs_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: file_status file_status_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: metrics metrics_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: password_resets password_resets_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_content_generated social_content_generated_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_feedback_insights social_feedback_insights_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_post_performance social_post_performance_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_scheduling social_scheduling_pkey; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: password_resets unique_user_id; Type: CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: idx_auth_logs_action; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_auth_logs_created_at; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_auth_logs_email; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_auth_logs_status; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_auth_logs_tenant; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_embeddings_created_at; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_embeddings_file_id; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_embeddings_filename; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_embeddings_text; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_embeddings_vector; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_enrichment_logs_created_at; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_enrichment_logs_document_id; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_enrichment_logs_status; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_enrichment_logs_tenant; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_enrichment_logs_tenant_status; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_file_status_filename_trgm; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_file_status_status; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_file_status_status_updated; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_file_status_updated; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_metrics_name_time; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_metrics_tags; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_password_resets_token_hash; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_password_resets_user_id; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_content_episode; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_content_posted; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_content_status; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_insights_pattern; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_insights_platform; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_performance_content; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_performance_content_platform_unique; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_performance_platform; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_performance_tier; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_scheduling_day; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_scheduling_platform; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_social_scheduling_platform_day; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_user_sessions_expires_at; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_user_sessions_last_accessed; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_user_sessions_user_expires; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_user_sessions_user_id; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: idx_users_role; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: ux_embeddings_file_idx; Type: INDEX; Schema: core; Owner: postgres
--
...
--
-- Name: password_resets password_resets_user_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_content_generated social_content_generated_file_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: postgres
--
...
--
-- Name: social_post_performance social_post_performance_content_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: postgres
--
...
\unrestrict 2oHLPYphtzw24nC64uKl1pK5D7e8Mz5qaEg4JY3CDqUSfmACfz6WlMRZkTZ9GzG
